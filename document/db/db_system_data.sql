-- 用户
INSERT INTO db_system.t_user (id, name, email, avatar, state, created_by, created_at, updated_by, updated_at, deleted)
VALUES (1934276682383138817, '平台管理员', 'yangxj96@gmail.com', NULL, 0, 0, '2025-06-15 23:47:52.864290', 1927290201865945090,
...
INSERT INTO db_system.t_user_role_map (id, user_id, role_id, created_by, created_at, updated_by, updated_at, deleted)
VALUES (1937706587291320321, 1937706586813169665, 1932687324356775938, 0, '2025-06-25 10:57:05.812216', 0, '2025-06-25 10:57:05.812216', NULL);

-- 角色
INSERT INTO db_system.t_role (id, name, code, state, scope, remark, created_by, created_at, updated_by, updated_at, deleted)
VALUES (1932682189593350146, '运维管理员', 'DEV_ADMIN', TRUE, 2, '运维人员使用,全局范围,拥有所有权限', 1927290201865945090,
        '2025-06-11 14:11:56.208812', 1927290201865945090, '2025-06-11 14:33:59.593709', NULL);
INSERT INTO db_system.t_role (id, name, code, state, scope, remark, created_by, created_at, updated_by, updated_at, deleted)
VALUES (1932687324356775938, '小组长', 'GROUP_LEADER', FALSE, 1, '测试禁用状态', 1927290201865945090, '2025-06-11 14:32:20.385948',
        1927290201865945090, '2025-06-12 17:15:18.034439', NULL);
INSERT INTO db_system.t_role (id, name, code, state, scope, remark, created_by, created_at, updated_by, updated_at, deleted)
VALUES (1932685785802162178, '系统管理员', 'SYS_ADMIN', TRUE, 0, '系统管理员,管理整个系统的,但是看不到系统运维相关的一些内容', 1927290201865945090,
...
INSERT INTO db_system.t_menu (id, pid, icon, name, path, component, layout, sort, created_by, created_at, updated_by, updated_at, deleted)
VALUES (1929928379667386370, 0, 'icon-setting', '组件示例', '/example', 'layout', 'layout', 1, 1927290201865945090, '2025-06-05 11:37:45.581760',
        1927290201865945090, '2025-06-05 11:37:45.582763', NULL);
INSERT INTO db_system.t_menu (id, pid, icon, name, path, component, layout, sort, created_by, created_at, updated_by, updated_at, deleted)
VALUES (1929928379575111682, 0, 'icon-setting', '系统管理', '/system', 'layout', 'layout', 0, 1927290201865945090, '2025-06-05 11:37:45.581760',
        1927290201865945090, '2025-06-05 11:37:45.582763', NULL);
