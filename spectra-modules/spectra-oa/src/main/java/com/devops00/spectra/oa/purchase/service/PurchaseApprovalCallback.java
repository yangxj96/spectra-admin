...
public class PurchaseApprovalCallback implements ApprovalCallback {
    ...
    public static final String PROCESS_DEFINITION_KEY = "oa_purchase_approval";
    ...
    public void onApproved(String businessKey, Map<String, Object> variables) {
        purchaseService.onApproved(businessKey, variables);
    }

    @Override
    public void onRejected(String businessKey, String reason) {
        purchaseService.onRejected(businessKey, reason);
    }

    @Override
    public void onTerminated(String businessKey, String reason) {
        purchaseService.onTerminated(businessKey, reason);
    }
}
