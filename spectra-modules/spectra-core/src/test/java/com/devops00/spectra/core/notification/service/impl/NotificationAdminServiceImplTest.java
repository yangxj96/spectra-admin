...
import com.devops00.spectra.core.notification.javabean.vo.NotificationOverviewErrorVO;
import com.devops00.spectra.core.notification.javabean.vo.NotificationOverviewTrendVO;
...
class NotificationAdminServiceImplTest {
    ...
    void shouldQueryRequestDetailWithoutSensitivePayload() {
        var requestMapper = mock(NotificationRequestMapper.class);
        var entity = new com.devops00.spectra.core.notification.javabean.entity.NotificationRequestEntity();
    ...
    void shouldQueryTaskDetailThroughTheSanitizedConverter() {
        ...
        var view = new com.devops00.spectra.core.notification.javabean.vo.NotificationTaskAdminVO();
