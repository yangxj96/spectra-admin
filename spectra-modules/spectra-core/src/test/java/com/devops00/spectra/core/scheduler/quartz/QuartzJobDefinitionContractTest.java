...
package com.devops00.spectra.core.scheduler.quartz;
...
class QuartzJobDefinitionContractTest {
    ...
    void jobCatalogMustExposeOnlyCodeOwnedDefinitions() throws IOException {
        var corePaths = List.of(
                "scheduler/quartz/catalog/QuartzJobCatalog.java",
                "scheduler/quartz/catalog/QuartzJobRegistrar.java");
        ...
        var commonPaths = List.of(
                "port/scheduler/quartz/QuartzJobDefinition.java",
                "port/scheduler/quartz/QuartzTriggerTemplate.java",
                "port/scheduler/quartz/QuartzParameterSchema.java");
