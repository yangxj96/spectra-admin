...
public record RateLimitPolicy(
    ...
    private static final List<RateLimitPolicy> DEFAULT_POLICIES = List.of(
            ...
            new RateLimitPolicy("authentication-mfa", Duration.ofMinutes(5), 10, SubjectDimension.IP,
                    List.of(new Endpoint("POST", "/security/authentication/mfa/verify"),
                            new Endpoint("POST", "/security/authentication/mfa/complete"))),
            new RateLimitPolicy("mfa-recovery", Duration.ofMinutes(10), 10, SubjectDimension.IP,
                    List.of(new Endpoint("POST", "/security/mfa/recovery/verify"))),
